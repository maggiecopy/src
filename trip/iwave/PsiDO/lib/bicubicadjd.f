	subroutine bicubicadjd(x1in,dxin,nxin,y1in,dyin,nyin,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
	...
	double precision x1in,dxin,y1in,dyin,zin(nxin,nyin)  
	double precision x1out,dxout,y1out,dyout,zout(nxout,nyout)

	integer gin,gout,gwork,ptr1,ptr2,ptr3,wl2,wl
	double precision work(wl)
...
c
	...
	if (wl.lt.gin+gout+gwork+nxout*nyin) then
		ierr=10
		write(6,*)'**Error in bicubic spline adjoint program**'
		write(6,*)'       not enough workspace'
		write(6,*)wl,' was length provided'
		write(6,*)gin+gout+gwork+nxout*nyin,' was length needed'
		return
	end if
...
c
 ...
 50	continue
	...
	wl2=wl-ptr3+1
	call cubictransd(x1in,dxin,work(ptr1),nxin,x1out,
...
c
 ...
 150	continue
	call cubictransd(y1in,dyin,work(ptr1),nyin,y1out,
